...
<template>
  <div class="flex h-screen flex-col bg-blue-1-light dark:bg-blue-1-dark">
    <header class="mx-auto my-6 flex h-20 w-11/12 items-center justify-between">
      ...
      <div class="flex h-16 grow items-center rounded-2xl bg-blue-2-light px-16 dark:bg-blue-2-dark">
        ...
        <nav class="align-center flex flex-grow items-center justify-center gap-2">
          <NuxtLink :to="progressStore.prevLevelString" @click="progressStore.decrementLevel" title="Previous Level">
          ...
          <NuxtLink :to="progressStore.nextLevelString" @click="progressStore.incrementLevel" title="Next Level">
